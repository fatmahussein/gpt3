...
```bash
git clone https://github.com/fatmahussein/gpt3.git
```
...
- [ ] 📱 **Implement the Sign in/ sign up functionalities**
...
Feel free to check the [issues page](https://github.com/fatmahussein/gpt3/issues).
...
I would like to give credit to this figma design https://www.figma.com/design/lz9lLpFHMxHm2odnwM3R0z/gpt3?node-id=0-15&t=uC2gvzQ81oBrcTWU-0 as required by the [Creative Commons License](https://creativecommons.org/licenses/).
